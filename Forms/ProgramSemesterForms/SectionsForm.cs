    ...
    public partial class SectionsForm : Form
    {
        ...
        public void FillGrid(string searchvalue)
        {
            ...
            try
            {
                ...
                DataTable sectionlist = DataBase_Layer.Retrive(query);
            ...
            {
                MessageBox.Show("Some unexpected issue occure Please Try Again!");
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = DataBase_Layer.Retrive("select * from SectionTable where SectionTitle = '" + txtTitle.Text.Trim() + "' and ProgramSemesterID = '" + cmbSemester.SelectedValue + "'");
                if (dt != null)
                {
                    if (dt.Rows.Count > 0)
                    {
                ...
                string insertquery = string.Format("insert into SectionTable(SectionTitle,ProgramSemesterID) values('{0}','{1}')", txtTitle.Text.Trim(), cmbSemester.SelectedValue);
